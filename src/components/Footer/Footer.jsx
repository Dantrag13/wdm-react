        ...
        <div>
            <footer>
                ...
                <div class="footer__inner-wrapper">
                    ...
                    <div class="third-col__wrapper1">
                        <h3>address</h3>
                        <p class="footer__adress">Lorem ipsum set amet</p>
                    </div>
                    <div class="third-col__wrapper2">
                        <h3>our office hours</h3>
                        <p class="footer__work-hours">Mon-Fr: 8:00-18:00 GMT Sat/Su: Closed</p>
                    </div>
                    </div>
